      ...
      <form onSubmit={handleSubmit} className="text-center p-4 border rounded bg-warning mt-1">
          ...
          <div className="mb-3 row">
            ...
            <div className="col-sm-6 d-flex align-items-center">
              ...
              <span className="btn btn-secondary btn-sm ms-2">
                <a href="https://inazuma-eleven.fr/team-builder/app.html" target="_blank" rel="noopener noreferrer" className="text-white text-decoration-none">
                  Imágenes
                </a>
              </span>
            </div>
